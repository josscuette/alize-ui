...
function useAlizeChartColors() {
  const [colors, setColors] = React21.useState({
    categorical: [
      "#aa9888",
      "#3e778b",
      "#6ea2b3",
