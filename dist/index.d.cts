 ...
 */
declare function JLLLogo({ className, ...props }: React.ComponentProps<"svg">): React.ReactElement;
 ...
 *
 * @param props - Logo props including productName, size, and standard HTML div attributes
 * @returns A logo element with appropriate styling
 *
 * @example
 * ```tsx
 ...
 * ```
 */
declare function Table$1({ className, ...props }: TableProps): React.ReactElement;
/**
 ...
 */
declare function SortableHeader({ column, children, className, }: {
    column: {
 ...
 * @example
 * ```tsx
 * import { DataTable, ColumnDef } from 'alize-ui';
 *
 ...
 * ```
 */
declare function DataTable<TData, TValue>({ columns, data, enableRowSelection, enableFiltering, filterPlaceholder, filterColumn, enableGlobalFilter, enablePagination, pageSizeOptions, pageSize, enableColumnVisibility, enableColumnReordering, enableColumnPinning, pinnedColumns, variant, density, className, emptyMessage, onRowSelectionChange, showToolbar, }: DataTableProps<TData, TValue>): react_jsx_runtime.JSX.Element;
...
declare function DataList({ children, density, dividers, bordered, className, }: DataListProps): react_jsx_runtime.JSX.Element;
declare function DataListGroup({ title, icon, collapsible, collapsed: controlledCollapsed, onCollapseChange, children, className, }: DataListGroupProps): react_jsx_runtime.JSX.Element;
declare function DataListItem({ id, title, subtitle, thumbnail, expandable, expandedContent, expanded: controlledExpanded, onExpandChange, actions, selectable, selected: controlledSelected, onSelectChange, metadata, children, className, onClick, }: DataListItemProps): react_jsx_runtime.JSX.Element;
...
declare function DataListEmpty({ icon, title, description, action, className, }: DataListEmptyProps): react_jsx_runtime.JSX.Element;
...
declare function DataListSkeleton({ count, showThumbnail, className, }: DataListSkeletonProps): react_jsx_runtime.JSX.Element;
 ...
 * ```
 */
declare function Sparkline({ data, type, color, width, height, showMarkers, lineWidth, className, ariaLabel, }: SparklineProps): react_jsx_runtime.JSX.Element;
 ...
 * ```
 */
declare function Sparkbar({ data, color, thresholds, width, height, gap, className, ariaLabel, }: SparkbarProps): react_jsx_runtime.JSX.Element;
interface SparkBulletProps {
    /** Current value (0-100) */
    value: number;
    /** Target value (0-100) */
    target?: number;
 ...
 * ```
 */
declare function SparkBullet({ value, target, ranges, width, height, className, ariaLabel, }: SparkBulletProps): react_jsx_runtime.JSX.Element;
 ...
 * ```
 */
declare function SparkTrend({ value, previousValue, change, formatValue, higherIsBetter, history, sparklineWidth, className, }: SparkTrendProps): react_jsx_runtime.JSX.Element;
/**
 * SparklineCell - Wrapper for use in TanStack Table cells
 */
declare function SparklineCell(props: SparklineProps): react_jsx_runtime.JSX.Element;
/**
 * SparkbarCell - Wrapper for use in TanStack Table cells
 */
declare function SparkbarCell(props: SparkbarProps): react_jsx_runtime.JSX.Element;
/**
 * SparkBulletCell - Wrapper for use in TanStack Table cells
 */
declare function SparkBulletCell(props: SparkBulletProps): react_jsx_runtime.JSX.Element;
/**
 * SparkTrendCell - Wrapper for use in TanStack Table cells
 */
declare function SparkTrendCell(props: SparkTrendProps): react_jsx_runtime.JSX.Element;
...
declare function useAlizeDevTools(): AlizeDevToolsContextValue;
/**
 * Props for the AlizeDevToolsProvider component
 */
interface AlizeDevToolsProviderProps {
    children: React.ReactNode;
    /**
